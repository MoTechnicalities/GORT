...
const PHASE62_RUNTIME_CONTINUITY_BEFORE: &str = "RUGC_PHASE62_RUNTIME_CONTINUITY_BEFORE";
const PHASE62_RUNTIME_CONTINUITY_AFTER_PRE: &str =
    "RUGC_PHASE62_RUNTIME_CONTINUITY_AFTER_PRE";
const PHASE62_RUNTIME_REGIONS_BEFORE: &str = "RUGC_PHASE62_RUNTIME_REGIONS_BEFORE";
const PHASE62_RUNTIME_REGIONS_AFTER_PRE: &str = "RUGC_PHASE62_RUNTIME_REGIONS_AFTER_PRE";
const PHASE62_RUNTIME_ANCHORS_BEFORE: &str = "RUGC_PHASE62_RUNTIME_ANCHORS_BEFORE";
const PHASE62_RUNTIME_ANCHORS_AFTER_PRE: &str = "RUGC_PHASE62_RUNTIME_ANCHORS_AFTER_PRE";
const PHASE62_RUNTIME_EXTERNAL_BEFORE: &str = "RUGC_PHASE62_RUNTIME_EXTERNAL_BEFORE";
const PHASE62_RUNTIME_EXTERNAL_AFTER_PRE: &str = "RUGC_PHASE62_RUNTIME_EXTERNAL_AFTER_PRE";
const PHASE62_RUNTIME_SUPPORT_SIGNAL: &str = "RUGC_PHASE62_RUNTIME_SUPPORT_SIGNAL";
const PHASE62_RUNTIME_CONTRADICTION_SIGNAL: &str =
    "RUGC_PHASE62_RUNTIME_CONTRADICTION_SIGNAL";
const PHASE62_V3B_BRANCH_TELEMETRY: &str = "RUGC_PHASE62_V3B_BRANCH";
const PHASE63_PLAN_TELEMETRY: &str = "RUGC_PHASE63_PLAN";
const PHASE63_TELEMETRY: &str = "RUGC_PHASE63_TELEMETRY";
const PHASE63_DIAGNOSTIC_TELEMETRY: &str = "RUGC_PHASE63_DIAGNOSTIC";
const PHASE63_REGIME_TELEMETRY: &str = "RUGC_PHASE63_REGIME";
const PHASE63_CANONICAL_PLAN: &str = "RUGC_PHASE63_CANONICAL_PLAN";
const PHASE63_CANONICAL_REGIME: &str = "RUGC_PHASE63_CANONICAL_REGIME";
const PHASE63_CANONICAL_TARGET: &str = "RUGC_PHASE63_CANONICAL_TARGET";
const PHASE63_ESCALATION_HANDOFF: &str = "RUGC_PHASE63_ESCALATION_HANDOFF";
const PHASE66_TELEMETRY: &str = "RUGC_PHASE66_TELEMETRY";
const PHASE67_TELEMETRY: &str = "RUGC_PHASE67_TELEMETRY";
...
pub fn apply_phase62_structural_experiment(
    ...
    if let Ok(target_novelty) = env::var("RUGC_PHASE62_TARGET_NOVELTY") {
